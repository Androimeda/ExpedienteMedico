...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">   
        <div class="row well card">
            <div class="col-lg-12" id="titulo">
                ...
                <h1>Registro de Hospitalizaciones (Ingreso)</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6 well card">
                ...
                <table class="table">
                    ...
                    <tr>
                      <td>Cama</td>
                      <td colspan="2"><input type="number" class="form-control" min=1 id="txt-cama"></td>
                    </tr>
                    <tr>
                        <td>Fecha/Hora</td>
    ...
    <script src="controlador/hospitalizar.js"></script>
  </body>
</html>
