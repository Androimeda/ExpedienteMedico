...
<html lang="es">
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-lg-12">
          <a href="hospitalizar.php" class="btn btn-primary">Agrega Hospitalizaciones <span class="glyphicon glyphicon-plus"></span></a>
        </div>
      </div>
    </div> <!-- /container -->
    ...
    <script src="controlador/listar-hospitalizados.js"></script>
  </body>
</html>
