...
<html lang="es">
  ...
  <body>
            ...
            <div class="row">
              ...
              <div class="col-lg-9">
                ...
                <table class="table">
                  ...
                  <tr>
                    <td>No Colegiación: </td>
                    <td colspan="2"><input class="form-control" type="text" id="txt-nocolegiacion" placeholder="Número de Colegiación"></td>
                  </tr>
                  <tr>
                    <td>Especialidad</td>
                    <td colspan="2">
                      <select class ="form-control" id="slc-especialidad">
                  ...
                  <tr>
                    <td colspan="3">
                      <button type="button" class="btn btn-block btn-primary" onclick="registrar()">Registrar Médico</button>
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <script src="controlador/agregar-medico.js"></script>
  </body>
</html>
